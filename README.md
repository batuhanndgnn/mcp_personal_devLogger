...
- [Kurulum](#kurulum)
  ...
  - [2. Docker ile Kurulum (Önerilen)](#2-docker-ile-kurulum-önerilen)
  - [3. Sanal Ortam](#3-sanal-ortam-virtual-env)
  - [4. Bağımlılıkları Yükleme](#4-bağımlılıkları-yükleme)
  - [5. Claude Desktop Ayarı](#5-claude-desktop-ayarı)
  - [6. Cursor Ayarı](#6-cursor-ayarı)
...
stdio üzerinden çalıştığı için terminalde girdi bekleyecektir; gerçek testler için [MCP Inspector](https://www.google.com/search?q=https://github.com/modelcontextprotocol/inspector) kullanmanızı öneririm:
