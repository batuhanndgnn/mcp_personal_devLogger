...
```bash
git clone https://github.com/<kullanici-adiniz>/mcp_personal_devLogger.git
cd mcp_personal_devLogger
```

> **Not:** Kurulumdan sonra bu klasörü **taşımayın veya yeniden adlandırmayın**. Aşağıda 4. ve 5. adımlarda tanımlayacağınız config dosyaları, bu klasörün **tam ve sabit** yolunu referans alır. Klasörü taşırsanız config'i de güncellemeniz gerekir (bkz. [Sorun Giderme](#sorun-giderme)).
